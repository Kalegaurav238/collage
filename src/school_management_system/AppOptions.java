 ...
 * @author SAURABH
 */
public class AppOptions extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AppOptions().setVisible(true);
            }
        });
    }
